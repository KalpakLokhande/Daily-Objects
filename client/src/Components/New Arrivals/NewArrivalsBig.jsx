        ...
        <div className='newArrivalsBig' >
            <div className="left">
                <div className="container">
                    ...
                    <p style={{ fontSize: '18px', fontWeight: '600', color: '#090909', marginTop: '20px' }} >Organizers</p>
                    <p style={{ fontSize: '12px', fontWeight: '400', color: '#090909' }} >Shop Now</p>
                </div>
            </div>
            <div className="right">
                <div className="container">
                    ...
                    <p style={{ fontSize: '18px', fontWeight: '600', color: '#090909', marginTop: '20px' }} >Messenger</p>
                    <p style={{ fontSize: '12px', fontWeight: '400', color: '#090909' }} >Shop Now</p>
                </div>
            </div>
